...
Departure time - The latest possible time the user is willing to depart.
	08:00pm departure time means any flight that leaves BEFORE 08:00pm is valid
Return time - The latest possible the time the user is willing to arrive back from the return trip
	02:00pm return time means any returning flight that arrives BEFORE 02:00pm is valid
